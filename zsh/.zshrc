...
plugins=(git ssh-agent npm yarn thefuck rust jsontools bun man golang fzf fzf-tab zoxide colored-man-pages gnu-utils colorize command-not-found safe-paste common-aliases gitignore nvm npm node zsh-autosuggestions vscode web-search zsh-syntax-highlighting starship)
